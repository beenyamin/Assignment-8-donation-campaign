...
const DonateCard = ({card}) => {
  ...
  const { Picture, Title, Category,  color_btn_bg, color_card_bg, color_text_button,  Price } = card || {}
...
<div className="card card-side h-72  my-5  mx-5 " style={{ backgroundColor: color_card_bg }}>
<figure><img className='w-64 h-72 justify-start' src={Picture} alt=""/></figure>

<div className="card-body ">

  <button className=" py-2  rounded font-semibold text-xl" style={{ backgroundColor: color_btn_bg , color: color_text_button }}>{Category}</button>
